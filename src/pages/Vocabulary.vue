...
<template>
  <h1 class="text-3xl font-bold text-center mb-4 g-text">
    Practice vocabulary
  </h1>
  ...
  <div class="grid place-items-center">
    Well practiced?
    <RouterLink
      class="text-primary p-2 hover:bg-primary hover:text-slate-100 rounded"
      to="/quiz"
    >
  ...
  <p class="py-2 text-center font-bold text-lg mb-2">
    Search or Filter words by specific topics
  </p>
  ...
  <div class="flex flex-col md:flex-row items-center">
    <div class="pt-3 pb-6 flex flex-col md:flex-row w-full">
      <div class="flex items-center gap-2">
        <input
          ...
          class="p-2 border w-full rounded dark:bg-gray-900 dark:border-gray-800"
    ...
    <div class="mb-4 w-full">
      <div>
        <div
          class="p-2 border w-full flex flex-wrap rounded dark:bg-gray-900 dark:border-gray-800"
        >
          <div
            @click="handleTopics('all')"
            :class="{ 'bg-primary': selectedTopics.length === 0 }"
          ...
          <div
            ...
            :class="{ 'bg-primary': selectedTopics.includes(topic) }"
  ...
  <div
    class="rounded flex items-center justify-between border text-lg font-bold p-4 shadow-sm"
    v-if="words.length === 0"
  >
    <div>
  ...
  <div class="flex gap-2 flex-col">
    <div
      class="flex items-center justify-between p-3 gap-2 rounded border dark:border-gray-800"
    ...
    >
      ...
      <div class="flex items-center">
        <RouterLink :to="`/explanation?word=${item.en}`">
          <Button class="p-1 text-sm font-normal" variant="outline"
            >Explanation</Button
          >
        </RouterLink>
